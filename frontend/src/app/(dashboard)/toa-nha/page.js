    ...
    <div>
                ...
                <tr key={item.MaToaNha}>
                  ...
                  <td>
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>Tầng</div>
                    </div>
                  </td>
                  <td>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          ...
          <Form.Item name="SoLuongPhong" label="Số tầng">
            <InputNumber min={0} style={{ width: '100%' }} placeholder="Nhập số tầng" />
          </Form.Item>
        </Form>
      </Modal>
    </div>
